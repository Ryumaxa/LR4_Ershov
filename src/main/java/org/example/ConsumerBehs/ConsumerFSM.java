...
public class ConsumerFSM extends FSMBehaviour {
    private static final String SEND_REQUEST = "sendRequest", WAIT_RESULTS = "waitResults", WAIT_RESULTS_LAST = "waitResultsLast", SEND_CORRECTED_REQUEST = "sendCorrectedRequest", END = "End";
    public void onStart() {
        ...
        this.registerLastState(new ConsumerWaitingBeh(), WAIT_RESULTS_LAST);
        this.registerState(new SendRequestBeh(true), SEND_CORRECTED_REQUEST);
        ...
        this.registerDefaultTransition(SEND_CORRECTED_REQUEST, WAIT_RESULTS_LAST);
